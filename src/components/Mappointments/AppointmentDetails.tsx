...
const AppointmentDetails: React.FC<AppointmentDetailsProps> = ({
  ...
  const bookedSlots = (patientSlots || []).filter(slot => slot.patientName && slot.appointmentStatus);
  ...
  return (
    <>
      <Box sx={{ p: { xs: 1, sm: 0 }, display: 'flex', flexDirection: 'column', gap: 2, width: '100%' }}>
        <Typography variant="h6" sx={{ fontWeight: 600, color: '#34495e', mb: 2 }}>
          ...
          <Table sx={{ minWidth: 650 }}>
            <TableHead sx={{ bgcolor: '#f7f9fc' }}>
              <TableRow>
                ...
                <TableCell sx={{ fontWeight: 600, color: '#34495e' }}>Patient Name</TableCell>
                <TableCell sx={{ fontWeight: 600, color: '#34495e' }}>MRN</TableCell>
                <TableCell sx={{ fontWeight: 600, color: '#34495e' }}>Gender</TableCell>
