...
const menuItems: MenuItem[] = [
    ...
    { 
        ...
        subItems: [
            ...
            { text: 'Configure Charge Events & Collection', icon: <AccountBalanceIcon />, url: '/policy_config/configure-charge' },
        ],
    },
    { 
        text: 'Billing Desk', 
        ...
        url: '/billing',
        subItems: [
            { text: 'Generate Invoice', icon: <ReceiptIcon />, url: '/billing/invoice' },
            { text: 'Payment Collection', icon: <AttachMoneyIcon />, url: '/billing/collection' },
            { text: 'Invoice History', icon: <DescriptionIcon />, url: '/billing/history' },
            { text: 'NEW APPS AS REFERENCE POINT', icon: <LocalPharmacyIcon />, url: '/billing/reference' },
        ],
    },
    { 
        text: 'Front Desk', 
    ...
    { 
        ...
        url: '/reports',
        subItems: [
            { text: 'Revenue Analysis', icon: <BarChartIcon />, url: '/reports/revenue' },
            { text: 'Visit Reports', icon: <AssessmentIcon />, url: '/reports/visits' },
                                    ...
                                    <List component="div" className={styles.nestedMenu}>
                                        {item.subItems.map((subItem) => (
                                            <ListItem
                                                ...
                                                className={`${styles.menuItem} ${selectedItem === subItem.text ? styles.active : ''}`}
                                                sx={{
                                                    position: 'relative',
                                                }}
                                            >
