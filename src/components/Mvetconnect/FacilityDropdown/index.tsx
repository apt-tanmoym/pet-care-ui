...
const FacilityDropdown: React.FC<FacilityDropdownProps> = ({ onFacilitySelect, selectedFacility, showHelper }) => {
  ...
  const handleChange = (event: SelectChangeEvent<string>) => {
    ...
    const facility = facilities.find(f => f.facilityId.toString() === facilityId) || null;
    ...
    >
      ...
      >
        {facilities.map(facility => (
          <MenuItem key={facility.facilityId} value={facility.facilityId.toString()}>
