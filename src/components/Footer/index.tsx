    ...
    <div>
      ...
      <div className={styles.socialBox}>
        <div className={styles.socialMedia}>
          ...
          <a href="https://www.instagram.com/partsmojo/" target="_blank" rel="noopener noreferrer">
            <FaInstagram className={styles.icon} />
          </a>
          <a href="https://www.linkedin.com/company/partsmojo" target="_blank" rel="noopener noreferrer">
