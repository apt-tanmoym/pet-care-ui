...
interface Stat {
  ...
  icon: React.ComponentType<{ size?: string | number; color?: string }>; // allow string | number and color
  description: string;
}
          ...
          <Box>
            ...
            <Box sx={{ height: 264, width: '100%' }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={weeklyActivity} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                  ...
                  <YAxis fontSize={12} />
                  <Tooltip content={<CustomTooltip />} />
                  <Bar dataKey="visits" fill="#3b82f6" name="Site Visits" radius={[4, 4, 0, 0]} />
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', gap: 3, mt: 2 }}>
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <Box sx={{ width: 12, height: 12, bgcolor: '#3b82f6', borderRadius: '50%', mr: 1 }} />
